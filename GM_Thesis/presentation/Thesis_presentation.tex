...
\begin{itemize}
\item Elevate \emph{randomness} of the initial \emph{geometric monitoring} method\footfullcite{Sharfman2006GM}
\item Hierarchical node clustering scheme\footfullcite{Keren2014GMHetStreams}
\item Decouple matching from the data distribution at the nodes\footfullcite{Keren2014GMHetStreams}
...
%\begin{frame} \frametitle{Violation Detection in the Sphere}\framesubtitle{A Nested Optimization Problem}
%
%\end{frame}
...
\begin{itemize}
\item[] GM: the initial geometric monitoring method\footfullcite{Sharfman2006GM}
\item[] HM: the proposed heuristic balancing process
\item[] DIST: the proposed distance-based hierarchical node clustering
\item[] DISTR: the distribution-based hierarchical node clustering\footfullcite{Keren2014GMHetStreams}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item ``European Environmental Agency - AQ e-Reporting'' database\footfullcite{AirBase}
